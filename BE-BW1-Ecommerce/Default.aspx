                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 gy-3">
                            <div class="card wrapper h-100 w-100">
                                ...
                                <div class="card-footer">
                                    <a href="Dettagli.aspx?ID=<%# Eval("IDGiocoDaTavolo") %>" class="btn btn-outline-secondary">Dettagli</a>
                                    <asp:LinkButton ID="addToCart" runat="server" OnClick="addToCart_Click" CssClass="btn btn-outline-success"><i class="fa-solid fa-cart-plus"></i></asp:LinkButton>
                                </div>
                            </div>
                        </div>
                    </ItemTemplate>
